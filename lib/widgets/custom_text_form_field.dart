        ...
        border: defaultBorderDecoration ??
            OutlineInputBorder(
              ...
              borderSide: BorderSide(
                color: appTheme.black90001.withOpacity(0.47),
                width: 1,
              ),
            ),
...
extension TextFormFieldStyleHelper on CustomTextFormField {
  static OutlineInputBorder get outlineIndigo90001 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            8.00,
          ),
  ...
  static OutlineInputBorder get outlineBlack90001TL5 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            5.00,
          ),
        ...
        borderSide: BorderSide(
          color: appTheme.black90001.withOpacity(0.44),
          width: 1,
        ),
      );
  static OutlineInputBorder get outlineBlack900011 => OutlineInputBorder(
        borderSide: BorderSide(
          color: appTheme.black90001.withOpacity(0.19),
          width: 1,
        ),
      );
  static OutlineInputBorder get fillBlue700 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            6.00,
          ),
